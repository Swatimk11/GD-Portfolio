...
const Experience = () => {
  return (
    <section
      id="experience"
      className="scroll-mt-32 pb-24 px-[8vw] md:px-[8vw] lg:px-[8vw] font-sans bg-skills-gradient clip-path-custom-2"
    >
      {/* Section Title */}
      ...
      <div className="relative">
        {/* Vertical line */}
        <div className="absolute top-0 bottom-0 left-6 sm:left-1/2 transform sm:-translate-x-1/2 w-1 bg-white"></div>
        ...
        {experiences.map((experience, index) => (
          ...
          >
            {/* Circle marker */}
            <div className="absolute left-6 sm:left-1/2 transform sm:-translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-10 h-10 sm:w-14 sm:h-14 rounded-full flex justify-center items-center z-10">
              <img
                src={experience.img}
